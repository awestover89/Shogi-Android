...
public class GoldGeneral implements Piece {

	private int curX, curY, dir;
	public final boolean PROMOTED = false;
	
	public GoldGeneral(int startX, int startY){
		curX = startX;
		curY = startY;
		if(curX < 3)
			dir = 1;
	...
	public boolean moveIsLegal(int newX, int newY) {
		...
		// Gold general can move one space Up, Down, Left or Right
	...
	public int getId(boolean japanese) {
		if(japanese)
			return R.drawable.goldjp;
		return R.drawable.goldeng;
	}
