...
public class PromotedSilver implements Piece {

	private int curX, curY, dir;
	public final boolean PROMOTED = true;
	
	public PromotedSilver(int startX, int startY){
		curX = startX;
		curY = startY;
		if(curX < 3)
			dir = 1;
	...
	public boolean moveIsLegal(int newX, int newY) {
		...
		// Promoted Silver can move one space Up, Down, Left or Right
	...
	public int getId(boolean japanese) {
		if(japanese)
			return R.drawable.silverpromjp;
		return R.drawable.silverpromeng;
	}
