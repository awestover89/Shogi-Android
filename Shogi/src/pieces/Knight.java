...
public class Knight implements Piece {
	...
	public boolean moveIsLegal(int newX, int newY) {
		...
		// Knight can move 2 spaces Up and 1 Space Left or Right
		
		if(Math.abs(newY - curY) == 1 && newX - curX == 2*dir)
			return true;
	...
	public int getId(boolean japanese) {
		if(japanese)
			return R.drawable.knightjp;
		return R.drawable.knighteng;
	}
